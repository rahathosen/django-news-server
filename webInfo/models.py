...
class WebsiteInfo(models.Model):
    ...
    head_editor = models.CharField(max_length=100,blank=True, default= "", verbose_name='Head Editor')
    editor = models.CharField(max_length=100,blank=True, default= "", verbose_name='Editor')
    publisher = models.CharField(max_length=100,blank=True, default= "", verbose_name='Publisher')
